...
(2, 'KhaÌch haÌ€ng Demo 1', 'customer01@gametopup.com', '$2b$10$bppKKRHPleFWDR2TXpWO1O4ZQ5RmI/Zm6t8hQJxttsaM3Dfq6Ya5u', 0),
(3, 'KhÃ¡ch hÃ ng Demo 2', 'customer02@gametopup.com', '$2b$10$bppKKRHPleFWDR2TXpWO1O4ZQ5RmI/Zm6t8hQJxttsaM3Dfq6Ya5u', 0);
...
(2, 'LiÃªn QuÃ¢n Mobile', 'https://example.com/games/lien-quan.png', 1),
...
(8, 'Blood Strike: VÃ¢y Háº¡m', 'https://example.com/games/blood-strike.png', 1),
...
(12, 'HÃ nh TrÃ¬nh Báº¥t Táº­n', 'https://example.com/games/hanh-trinh-bat-tan.png', 1);
...
(4, '40 QuÃ¢n Huy', 2, 20000, 25000, 16000, 100),
(5, '200 QuÃ¢n Huy', 2, 95000, 120000, 82000, 60),
(6, '999 QuÃ¢n Huy', 2, 399000, 459000, 350000, 25),
...
(2, 1, 'Acc ChiÌnh Free Fire', 'ff_998877', 'VN', 1),
(2, 2, 'Acc Leo Rank LiÃªn QuÃ¢n', 'lq_223344', 'Máº·t Trá»i', 0),
...
(1, 2, 500000.00, 0.00, 500000.00, 1, 'Náº¡p tiá»n khá»Ÿi táº¡o há»‡ thá»‘ng'),
(2, 3, 300000.00, 0.00, 300000.00, 1, 'Náº¡p tiá»n khá»Ÿi táº¡o há»‡ thá»‘ng');
