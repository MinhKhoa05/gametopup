  ...
  return (
    <div className="mx-auto max-w-[1120px]">
      ...
      <div className="gametopup-surface p-[22px] max-[760px]:p-4">
        ...
        <button className="mb-4 inline-flex items-center gap-2 border-0 bg-transparent p-0 text-[0.84rem] font-bold text-slate-400 hover:text-cyan-50" type="button" onClick={() => navigate({ name: 'games' })}>
          <ArrowLeft size={15} />
