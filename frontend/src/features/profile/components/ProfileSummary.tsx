...
import { Badge, IconBox, StatCard } from '@/shared/components';
import { formatCurrency } from '@/shared/lib/format';
import { isAdminUserRole } from '@/features/auth/userRole';
...
export function ProfileSummary({
  ...
  const roleLabel = isAdminUserRole(user.role) ? 'Quản trị viên' : 'Tài khoản cá nhân';
