...
import { Badge, Button, Field, IconBox, RecordRow, SectionHeading, StepProgress } from '@/components/ui';
import { useRoute } from '@/hooks/common/route.hooks';
import { formatCurrency } from '@/lib/format';
import { classNames } from '@/lib/ui';
import { DepositRequest, WalletInfo } from '@/features/wallet/wallet.types';
