...
const BASE_CLASS = 'grid w-full gap-4 rounded-2xl border border-white/5 bg-white/3 p-6 text-slate-200';
  ...
  const content = (
    <>
      ...
      <div className="min-w-0 space-y-1">
        ...
        {description && <span className="block text-sm leading-[1.45] text-slate-400">{description}</span>}
      </div>
