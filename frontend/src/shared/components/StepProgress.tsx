...
function StepProgressComponent({ steps, currentStep, className }: StepProgressProps) {
  return (
    <div className={classNames('step-progress-shell mx-auto grid w-full gap-3', className)}>
      <div
...
function StepProgressItem({
  ...
  return (
    <div className="relative grid items-start justify-items-center gap-1.5 px-1 text-center">
      <div className={classNames('relative z-10 flex size-11 items-center justify-center rounded-full border transition-all duration-300 ease-out will-change-transform', circleClassName)}>
        {stepState === 'done' ? (
